...
Examples:
  # Analyze a single experiment
  python -m hovercraft_data_analysis.timestamp_analysis --experiment "1a_1_Minimum_Radius_Turn/afternoon/007_Fast_stbd_turn_1"
  
  # Analyze all experiments
  python -m hovercraft_data_analysis.timestamp_analysis --all
  
  # Auto-detect sampling rates
  python -m hovercraft_data_analysis.timestamp_analysis --experiment "path/to/experiment" --update-spec
  
  # Use custom sensor specs
  python -m hovercraft_data_analysis.timestamp_analysis --experiment "path/to/experiment" --spec custom_specs.yaml
        """
    )
