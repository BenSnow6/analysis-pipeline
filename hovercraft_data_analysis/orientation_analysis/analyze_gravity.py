...
def analyze_gravity_measurements():
    ...
    possible_paths = [
        ...
        base_path / "02_Evaluation_Experiments" / "1a_1_Minimum_Radius_Turn" / "morning" / experiment / sensor / f"accel_{experiment}.csv",
        base_path / "02_Evaluation_Experiments" / "1a_1_Minimum_Radius_Turn" / "morning" / experiment / "IMU" / sensor / f"accel_{experiment}.csv"
    ]
