...
def test_load_data():
    ...
    csv_file = Path(__file__).parent.parent / "alignment_analysis" / "aligned_data" / "007_Fast_stbd_turn_1_csv" / "Sensor_3.csv"
...
def test_orientation_config():
    ...
    config_file = Path(__file__).parent / "orientation_config.yaml"
...
def test_experiment_paths():
    ...
    base_path = Path(__file__).parent.parent.parent / "02_Evaluation_Experiments"
